...
class TestGLSLParser(unittest.TestCase):
    ...
    def test_if_else_if_else(self):
        ...
        expected_ast = IfNode(
            ...
            if_body=[FunctionCallNode("doSomething", [])],  # Assuming doSomething() is parsed as FunctionCallNode
            else_body=IfNode(
                condition=BinaryOpNode(
                    left=VariableNode("a"),
                    op="<",
...
# Define supporting nodes for the AST (these should match your parser's output format)
